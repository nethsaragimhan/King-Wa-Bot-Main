...
let SewQueen = require('king-bot-pro/sources/dc/handler');
...
KingBot['IntroduceCMD']({on: 'text', fromMe: false, delownsewcmd: false}, (async (message, input) => {
...
KingBot['IntroduceCMD']({on: 'text', fromMe: true, delownsewcmd: false}, (async (message, input) => {
...
KingBot['IntroduceCMD']({pattern: 'afk ?(.*)', fromMe: true, delownsewcmd: false, desc: DATA.AFK_DESC}, (async (message, input) => {     
    if (!AFK.isAfk) {
