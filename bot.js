...
// ════════════════════WA CONNECTION🍁🍁🍁
    ...
    conn.on('connecting', async () => {
        console.log(`${chalk.green.bold('👑𝐊𝐢𝐧𝐠👑')}${chalk.blue.bold('BOT')}
...
*/
                        try {
                            ...
                            if (config.LANG == 'EN') {
                                await conn.sendMessage(conn.user.jid, fs.readFileSync("./src/24b9b8507613125d34bd1.jpg"), MessageType.image, { caption: '[🇱🇰𝐊𝐢𝐧𝐠 𝐁𝐨𝐭✌️] WhatsApp User Bot V1.0.0  WORKING AS '+config.WORKTYPE+'!!\n\n👉 _This is your LOG number Dont Try Command here_\n▷Also You Can join Our Support group More Help.\n_🖲️Support 01▷ https://chat.whatsapp.com/IjIfAWY5rGt16lgwndTvbP\n\n*Error:* ```' + error + '```\n\n' });
                                
                            } else if (config.LANG == 'SI') {
                                await conn.sendMessage(conn.user.jid, fs.readFileSync("./src/24b9b8507613125d34bd1.jpg"), MessageType.image, { caption: '[🇱🇰𝐊𝐢𝐧𝐠 𝐁𝐨𝐭✌️] WhatsApp User Bot  V1.0.0 '+config.WORKTYPE+' ලෙස ක්‍රියා කරයි!!\n\n👉 _මෙය ඔබගේ LOG අංකයයි මෙහි විධන භාවිතයෙන් වළකින්න_\n▷ඔබට යම් ගැටලුවක් ඇත්නම් අපගේ සහය සමූහට ලිවිය හැක.\nf_🖲️Support 01▷ https://chat.whatsapp.com/IjIfAWY5rGt16lgwndTvbP\n\n*දෝෂය:* ```' + error + '```\n\n' });
