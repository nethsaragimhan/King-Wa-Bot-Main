let DataPack = require('king-bot-pro/export/output');
...
let SOL =require('king-bot-pro/console')
let {CheckUpdatesWeb, sendMessageownerMSG, sendMessageADSMSG, sendMessageBotOn, sendMessageGreetingMSG, sendMessageMSGMSG, sendMessageBlackListMSG, sendMessageBIOMSG} = require('king-bot-pro/sources/dc/king')
...
let {WAConnection, MessageOptions, MessageType, Mimetype, Presence} = require('nethsaragimhan/king-bot-web');  
let {Message, StringSession, Image, Video} =  require('king-bot-pro/sources/dc/Wa-Base/');
...
async function kingBot() {
        ...
        } else { console.log('Need KINGBOT_SESSION \n'.repeat(50));return;}
        ...
        DataKey.on('chat-update', async m => {
                ...
                await sendMessageMSGMSG(DataKey, msg, 'king', SQQA)
                });
        try {
